...
namespace Map.PointHolder {
    ...
    public class SerializedPointHolder {
        ...
        public NameCount[] Descriptions { get; private set; }
        public SerializedPointHolder(int tc, Point[] p, int[] pc, int oic, NameCount[] d) =>
        ...
        Point DeserializePropertiesToPoint(Properties properties, List<NameCount> possibleDescriptions) {
            ...
            if (descriptionIndex < 0) {
                ...
                possibleDescriptions.Add(new NameCount(properties.calldescription));
            }
        ...
        public static SerializedPointHolder APIDataToSerializedPointHolder(List<APIModels.Data> dataList, int totalCount) {
            ...
            List<NameCount> possibleDescriptions = new List<NameCount>();
            int pointCount = 0;
